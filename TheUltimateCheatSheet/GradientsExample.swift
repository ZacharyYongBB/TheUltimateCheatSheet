...
struct GradientsExample: View {
    var body: some View {
       ...
       //                    endRadius: 400)
                       AngularGradient(
                           gradient: Gradient(colors: [Color(#colorLiteral(red: 0.521568656, green: 0.1098039225, blue: 0.05098039284, alpha: 1)), Color(#colorLiteral(red: 1, green: 1, blue: 1, alpha: 1))]),
                           center: .topLeading,
